...
function ns.RestoreStaticPopUps()
    ...
    StaticPopupDialogs["Restore_Zone?"] = {
      ...
      OnCancel = function()
        print(TextIconMNL4:GetIconString() .. " " .. ns.COLORED_ADDON_NAME .. " " .. "|cffffff00 ".. L["Zones"] .. " - " .. L["Restore all deleted icons"] .."|cffff0000" .. " " .. CLUB_FINDER_CANCELED)
      end,
      timeout = 5,
    }
    StaticPopupDialogs["Restore_Continent?"] = {
      ...
      OnCancel = function()
        print(TextIconMNL4:GetIconString() .. " " .. ns.COLORED_ADDON_NAME .. " " .. "|cffffff00 ".. L["Continents"] .. " - " .. L["Restore all deleted icons"] .."|cffff0000" .. " " .. CLUB_FINDER_CANCELED)
      end,
      timeout = 5,
    }
    StaticPopupDialogs["Restore_Azeroth?"] = {
      ...
      OnCancel = function()
        print(TextIconMNL4:GetIconString() .. " " .. ns.COLORED_ADDON_NAME .. " " .. "|cffffff00 ".. AZEROTH .. " - " .. "|cffffff00 ".. L["Restore all deleted icons"] .."|cffff0000" .. " " .. CLUB_FINDER_CANCELED)
      end,
      timeout = 5,
    }
    StaticPopupDialogs["Restore_Dungeon?"] = {
      ...
      OnCancel = function()
        print(TextIconMNL4:GetIconString() .. " " .. ns.COLORED_ADDON_NAME .. " " .. "|cffffff00 ".. CALENDAR_TYPE_DUNGEON .. " - " .. L["Restore all deleted icons"] .."|cffff0000" .. " " .. " " .. CLUB_FINDER_CANCELED)
      end,
      timeout = 5,
    }
    StaticPopupDialogs["Restore_Capitals?"] = {
      ...
      OnCancel = function()
        print(TextIconMNL4:GetIconString() .. " " .. ns.COLORED_ADDON_NAME .. " " .. "|cffffff00 ".. L["Capitals"] .. " - " .. L["Restore all deleted icons"] .."|cffff0000" .. " " .. CLUB_FINDER_CANCELED)
      end,
      timeout = 5,
    }
  end