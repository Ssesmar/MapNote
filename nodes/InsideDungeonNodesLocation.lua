...
if not db.show.HideMapNote then
    ...
    if db.show.DungeonMap then
        ...
        --#############################
            ...
            nodes[328][47177426] = { mnID = 1527, name = L["Exit"] ..  " =>", type = "Exit", showInZone = true } -- Throne of the Four Winds
            ...
            nodes[1580][52648361] = { mnID = 1527, name = L["Exit"] ..  " =>", type = "Exit", showInZone = true } -- Ny'Alotha, The Waking City
        --####################################
        ...
        --####################################
            ...
            nodes[252][37854109] = { mnID = 33, name = L["Exit"] ..  " =>", type = "Exit", showInZone = true } -- Lower Blackrock Spire
            ...
            nodes[355][64416079] = { mnID = 42, name = L["Exit"] ..  " =>", type = "Exit", showInZone = true } -- Karazhan
            ...
            nodes[809][61778163] = { mnID = 42, name = L["Exit"] ..  " =>", type = "Exit", showInZone = true } -- Return to Karazhan
        ...
        --#############################
            ...
            nodes[142][51465242] = { mnID = 114, name = L["Exit"] ..  " =>", type = "Exit", showInZone = true } -- The Oculus
            ...
            nodes[157][88307487] = { mnID = 115, name = L["Exit"] ..  " =>", type = "Exit", showInZone = true } -- Azjol Nerub
        ...
        --#############################
            ...
            nodes[471][75437521] = { mnID = 379, name = L["Exit"] ..  " =>", type = "Exit", showInZone = true } -- Mogu'shan Vaults
        ...
        --#############################
            ...
            nodes[610][65258604] = { mnID = 550, name = L["Exit"] ..  " =>", type = "Exit", showInZone = true } -- Highmaul
            nodes[612][57026083] = { mnID = 550, name = L["Exit"] ..  " =>", type = "Exit", showInZone = true } -- Highmaul
        ...
        --##########################
          ...
          --Halls of Orientation
            nodes[297][67584914] = { mnID = 299, dnID = DUNGEON_FLOOR_HALLSOFORIGINATION3, name = "", type = "PassageUpL", showInZone = true } -- Hall des Lichts
            nodes[299][47334914] = { mnID = 297, dnID = DUNGEON_FLOOR_HALLSOFORIGINATION1, name = "", type = "PassageDownL", showInZone = true } -- Die Vier Sitze
            nodes[297][90454952] = { mnID = 298, dnID = DUNGEON_FLOOR_HALLSOFORIGINATION2, name = "", type = "PassageRightL", showInZone = true } -- Hall des Lichts
        ...
        --#################################
          ...
          --Blackrock Depths
            nodes[242][54366273] = { mnID = 243, dnID = DUNGEON_FLOOR_BLACKROCKDEPTHS2, name = "", type = "PassageRightL", showInZone = true }
            nodes[242][54853615] = { mnID = 243, dnID = DUNGEON_FLOOR_BLACKROCKDEPTHS2, name = "", type = "PassageDownL", showInZone = true }
            nodes[243][55268973] = { mnID = 242, dnID = DUNGEON_FLOOR_BLACKROCKDEPTHS1, name = "", type = "PassageLeftL", showInZone = true }
            nodes[243][54316569] = { mnID = 242, dnID = DUNGEON_FLOOR_BLACKROCKDEPTHS1, name = "", type = "PassageDownL", showInZone = true }
          ...
          --Lower Blackrock Spire
            ...
            nodes[255][42316024] = { mnID = 254, dnID = DUNGEON_FLOOR_BLACKROCKSPIRE5, name = "", type = "PassageLeftL", showInZone = true }
          --Blackwing Lair 
          ...
          -- Return to Karazhan
            nodes[350][53176335] = { mnID = 352, dnID = DUNGEON_FLOOR_KARAZHAN3, name = "", type = "PassageUpL", showInZone = true }
            nodes[350][39178933] = { mnID = 351, dnID = DUNGEON_FLOOR_KARAZHAN2, name = "", type = "PassageUpL", showInZone = true }
            nodes[350][38541234] = { mnID = 353, dnID = DUNGEON_FLOOR_KARAZHAN4, name = "", type = "PassageRightL", showInZone = true }
            nodes[351][24577457] = { mnID = 350, dnID = DUNGEON_FLOOR_KARAZHAN1, name = "", type = "PassageDownL", showInZone = true }
            nodes[351][74492442] = { mnID = 350, dnID = DUNGEON_FLOOR_KARAZHAN1, name = "", type = "PassageDownL", showInZone = true }
            nodes[351][38540982] = { mnID = 352, dnID = DUNGEON_FLOOR_KARAZHAN3, name = "", type = "PassageUpL", showInZone = true }
            nodes[352][52209216] = { mnID = 350, dnID = DUNGEON_FLOOR_KARAZHAN1, name = "", type = "PassageDownL", showInZone = true }
            nodes[352][39338392] = { mnID = 351, dnID = DUNGEON_FLOOR_KARAZHAN2, name = "", type = "PassageDownL", showInZone = true }
            nodes[352][69783612] = { mnID = 353, dnID = DUNGEON_FLOOR_KARAZHAN4, name = "", type = "PassageLeftL", showInZone = true }
            nodes[353][51738533] = { mnID = 355, dnID = DUNGEON_FLOOR_KARAZHAN6, name = "", type = "PassageDownL", showInZone = true }
            nodes[353][71354366] = { mnID = 352, dnID = DUNGEON_FLOOR_KARAZHAN3, name = "", type = "PassageDownL", showInZone = true }
            nodes[353][45602882] = { mnID = 350, dnID = DUNGEON_FLOOR_KARAZHAN1, name = "", type = "PassageLeftL", showInZone = true }
            nodes[353][22164974] = { mnID = 354, dnID = DUNGEON_FLOOR_KARAZHAN5, name = "", type = "PassageRightL", showInZone = true }
            nodes[354][42788328] = { mnID = 353, dnID = DUNGEON_FLOOR_KARAZHAN4, name = "", type = "PassageLeftL", showInZone = true }
            nodes[354][62712018] = { mnID = 355, dnID = DUNGEON_FLOOR_KARAZHAN6, name = "", type = "PassageUpL", showInZone = true }
            nodes[355][53456908] = { mnID = 353, dnID = DUNGEON_FLOOR_KARAZHAN4, name = "", type = "PassageUpL", showInZone = true }
            nodes[355][65656867] = { mnID = 356, dnID = DUNGEON_FLOOR_KARAZHAN7, name = "", type = "PassageRightL", showInZone = true }
            nodes[355][39481164] = { mnID = 354, dnID = DUNGEON_FLOOR_KARAZHAN5, name = "", type = "PassageDownL", showInZone = true }
            nodes[356][69466492] = { mnID = 355, dnID = DUNGEON_FLOOR_KARAZHAN9, name = "", type = "PassageLeftL", showInZone = true }
            nodes[356][54885976] = { mnID = 357, dnID = DUNGEON_FLOOR_KARAZHAN8, name = "", type = "PassageUpL", showInZone = true }
            nodes[356][50312324] = { mnID = 355, dnID = DUNGEON_FLOOR_KARAZHAN6, name = "", type = "PassageDownL", showInZone = true }
            nodes[357][53925190] = { mnID = 356, dnID = DUNGEON_FLOOR_KARAZHAN7, name = "", type = "PassageUpL", showInZone = true }
            nodes[358][60672018] = { mnID = 357, dnID = DUNGEON_FLOOR_KARAZHAN8, name = "", type = "PassageDownL", showInZone = true }
            nodes[358][30216415] = { mnID = 359, dnID = DUNGEON_FLOOR_KARAZHAN10, name = "", type = "PassageUpL", showInZone = true }
            nodes[359][60885865] = { mnID = 361, dnID = DUNGEON_FLOOR_KARAZHAN12, name = "", type = "PassageRightL", showInZone = true }
            nodes[359][36132076] = { mnID = 360, dnID = DUNGEON_FLOOR_KARAZHAN11, name = "", type = "PassageLeftL", showInZone = true }
            nodes[359][32716295] = { mnID = 358, dnID = DUNGEON_FLOOR_KARAZHAN9, name = "", type = "PassageDownL", showInZone = true }
            nodes[360][66012513] = { mnID = 359, dnID = DUNGEON_FLOOR_KARAZHAN10, name = "", type = "PassageRightL", showInZone = true }
            nodes[361][45925291] = { mnID = 359, dnID = DUNGEON_FLOOR_KARAZHAN10, name = "", type = "PassageLeftL", showInZone = true }
            nodes[361][25126043] = { mnID = 362, dnID = DUNGEON_FLOOR_KARAZHAN13, name = "", type = "PassageLeftL", showInZone = true }
            nodes[361][41081540] = { mnID = 363, dnID = DUNGEON_FLOOR_KARAZHAN14, name = "", type = "PassageRightL", showInZone = true }
            nodes[362][55958239] = { mnID = 361, dnID = DUNGEON_FLOOR_KARAZHAN12, name = "", type = "PassageDownL", showInZone = true }
            nodes[363][18458250] = { mnID = 361, dnID = DUNGEON_FLOOR_KARAZHAN12, name = "", type = "PassageLeftL", showInZone = true }
            nodes[363][82335496] = { mnID = 364, dnID = DUNGEON_FLOOR_KARAZHAN15, name = "", type = "PassageUpL", showInZone = true }
            nodes[363][38541823] = { mnID = 364, dnID = DUNGEON_FLOOR_KARAZHAN15, name = "", type = "PassageLeftL", showInZone = true }
            nodes[364][84597041] = { mnID = 365, dnID = DUNGEON_FLOOR_KARAZHAN16, name = "", type = "PassageUpL", showInZone = true }
            nodes[364][80016899] = { mnID = 363, dnID = DUNGEON_FLOOR_KARAZHAN15, name = "", type = "PassageDownL", showInZone = true }
            nodes[364][29443031] = { mnID = 363, dnID = DUNGEON_FLOOR_KARAZHAN15, name = "", type = "PassageRightL", showInZone = true }
            nodes[365][69937638] = { mnID = 365, dnID = DUNGEON_FLOOR_KARAZHAN15, name = "", type = "PassageDownL", showInZone = true }
            nodes[365][61147332] = { mnID = 366, dnID = DUNGEON_FLOOR_KARAZHAN17, name = "", type = "PassageUpL", showInZone = true }
            nodes[366][52118901] = { mnID = 365, dnID = DUNGEON_FLOOR_KARAZHAN17, name = "", type = "PassageDownL", showInZone = true }
        
         --##########################
        --#### Outland Passage #####
        --##########################
          --Black Temple
            nodes[339][28657991] = { mnID = 340, dnID = DUNGEON_FLOOR_BLACKTEMPLE1, name = "", type = "PassageDownL", showInZone = true } -- 
            nodes[339][76054672] = { mnID = 341, dnID = DUNGEON_FLOOR_BLACKTEMPLE2, name = "", type = "PassageRightL", showInZone = true } --       
            nodes[340][27240693] = { mnID = 339, dnID = DUNGEON_FLOOR_BLACKTEMPLE0, name = "", type = "PassageUpL", showInZone = true } -- 
          ...
          --The Arcatraz
            nodes[269][67872673] = { mnID = 270, dnID = DUNGEON_FLOOR_THEARCATRAZ2, name = "", type = "PassageUpL", showInZone = true }
            nodes[270][85635143] = { mnID = 269, dnID = DUNGEON_FLOOR_THEARCATRAZ1, name = "", type = "PassageDownL", showInZone = true }
            nodes[270][44195708] = { mnID = 271, dnID = DUNGEON_FLOOR_THEARCATRAZ3, name = "", type = "PassageRightL", showInZone = true }
            nodes[271][21348824] = { mnID = 270, dnID = DUNGEON_FLOOR_THEARCATRAZ2, name = "", type = "PassageLeftL", showInZone = true }
          --The Mechanar
            nodes[267][41702083] = { mnID = 268, dnID = DUNGEON_FLOOR_THEMECHANAR2, name = "", type = "PassageUpL", showInZone = true }
            nodes[268][41723445] = { mnID = 267, dnID = DUNGEON_FLOOR_THEMECHANAR1, name = "", type = "PassageDownL", showInZone = true }
          --The Steamvault
            nodes[263][47577798] = { mnID = 264, dnID = DUNGEON_FLOOR_THESTEAMVAULT2, name = "", type = "PassageDownL", showInZone = true }
            nodes[264][47807685] = { mnID = 263, dnID = DUNGEON_FLOOR_THESTEAMVAULT1, name = "", type = "PassageUpL", showInZone = true }
          --Sethekk Halls
            nodes[258][53149134] = { mnID = 259, dnID = DUNGEON_FLOOR_SETHEKKHALLS2, name = "", type = "PassageUpL", showInZone = true }
            nodes[259][49309485] = { mnID = 258, dnID = DUNGEON_FLOOR_SETHEKKHALLS2, name = "", type = "PassageLeftL", showInZone = true }
            nodes[259][49232701] = { mnID = 258, dnID = DUNGEON_FLOOR_SETHEKKHALLS1, name = "", type = "PassageRightL", showInZone = true } 
          --Auchenai Crypts 
            nodes[256][42551715] = { mnID = 257, dnID = DUNGEON_FLOOR_AUCHENAICRYPTS2, name = "", type = "PassageLeftL", showInZone = true }
            nodes[257][24831266] = { mnID = 256, dnID = DUNGEON_FLOOR_AUCHENAICRYPTS1, name = "", type = "PassageRightL", showInZone = true }
        
        --###########################
        --#### Northrend Passage ####
        --###########################
          --Drak'Tharon Keep
            nodes[160][62127171] = { mnID = 161, dnID = DUNGEON_FLOOR_DRAKTHARONKEEP2, name = "", type = "PassageLeftL", showInZone = true }
            nodes[161][50947189] = { mnID = 160, dnID = DUNGEON_FLOOR_DRAKTHARONKEEP1, name = "", type = "PassageDownL", showInZone = true }
            nodes[161][38071776] = { mnID = 160, dnID = DUNGEON_FLOOR_DRAKTHARONKEEP1, name = "", type = "PassageRightL", showInZone = true }
          --Utgarde Pinnacle
            nodes[137][59463342] = { mnID = 136, dnID = DUNGEON_FLOOR_UTGARDEPINNACLE1, name = "", type = "PassageDownL", showInZone = true }
            nodes[137][55665358] = { mnID = 136, dnID = DUNGEON_FLOOR_UTGARDEPINNACLE1, name = "", type = "PassageRightL", showInZone = true }
            nodes[137][43787526] = { mnID = 136, dnID = DUNGEON_FLOOR_UTGARDEPINNACLE1, name = "", type = "PassageRightL", showInZone = true }
            nodes[137][54417922] = { mnID = 136, dnID = DUNGEON_FLOOR_UTGARDEPINNACLE1, name = "", type = "PassageDownL", showInZone = true }
            nodes[136][54191762] = { mnID = 137, dnID = DUNGEON_FLOOR_UTGARDEPINNACLE2, name = "", type = "PassageUpL", showInZone = true }
            nodes[136][40094388] = { mnID = 137, dnID = DUNGEON_FLOOR_UTGARDEPINNACLE2, name = "", type = "PassageLeftL", showInZone = true }
            nodes[136][45918383] = { mnID = 137, dnID = DUNGEON_FLOOR_UTGARDEPINNACLE2, name = "", type = "PassageUpL", showInZone = true }
            nodes[136][28277624] = { mnID = 137, dnID = DUNGEON_FLOOR_UTGARDEPINNACLE2, name = "", type = "PassageUpL", showInZone = true }
          --Utgarde Keep
            nodes[133][47498422] = { mnID = 134, dnID = DUNGEON_FLOOR_UTGARDEKEEP2, name = "", type = "PassageRightL", showInZone = true }
            nodes[134][34516443] = { mnID = 133, dnID = DUNGEON_FLOOR_UTGARDEKEEP1, name = "", type = "PassageRightL", showInZone = true }
            nodes[134][53452160] = { mnID = 135, dnID = DUNGEON_FLOOR_UTGARDEKEEP3, name = "", type = "PassageUpL", showInZone = true }
            nodes[135][33504319] = { mnID = 134, dnID = DUNGEON_FLOOR_UTGARDEKEEP2, name = "", type = "PassageUpL", showInZone = true }
          --Halls of Lightning 
            nodes[138][89605368] = { mnID = 139, dnID = DUNGEON_FLOOR_HALLSOFLIGHTNING2, name = "", type = "PassageRightL", showInZone = true }
            nodes[139][56282082] = { mnID = 138, dnID = DUNGEON_FLOOR_HALLSOFLIGHTNING1, name = "", type = "PassageLeftL", showInZone = true }
          --Ulduar
            nodes[149][51188419] = { mnID = 148, dnID = DUNGEON_FLOOR_ULDUAR1, name = "", type = "PassageDownL", showInZone = true }
          --Trial of the Crusader  
            nodes[172][51194755] = { mnID = 173, dnID = DUNGEON_FLOOR_THEARGENTCOLISEUM2, name = "", type = "PassageDownL", showInZone = true }
          --IcecrownGlacier
            nodes[186][38998338] = { mnID = 187, dnID = DUNGEON_FLOOR_ICECROWNCITADEL2, name = "", type = "PassageUpL", showInZone = true }
            nodes[187][45508467] = { mnID = 186, dnID = DUNGEON_FLOOR_ICECROWNCITADEL1, name = "", type = "PassageDownL", showInZone = true }
            nodes[187][65995501] = { mnID = 188, dnID = DUNGEON_FLOOR_ICECROWNCITADEL3, name = "", type = "PassageRightL", showInZone = true }
            nodes[188][51611678] = { mnID = 190, dnID = DUNGEON_FLOOR_ICECROWNCITADEL5, name = "", type = "PassageUpL", showInZone = true }
            nodes[190][51838303] = { mnID = 188, dnID = DUNGEON_FLOOR_ICECROWNCITADEL2, name = "", type = "PassageDownL", showInZone = true }
            nodes[190][51885378] = { mnID = 192, dnID = DUNGEON_FLOOR_ICECROWNCITADEL1, name = "", type = "PassageUpL", showInZone = true }
            nodes[190][76689428] = { mnID = 189, dnID = DUNGEON_FLOOR_ICECROWNCITADEL4, name = "", type = "PassageDownL", showInZone = true }
            nodes[190][42422010] = { mnID = 191, dnID = DUNGEON_FLOOR_ICECROWNCITADEL6, name = "", type = "PassageDownL", showInZone = true }
            nodes[190][61272032] = { mnID = 191, dnID = DUNGEON_FLOOR_ICECROWNCITADEL6, name = "", type = "PassageDownL", showInZone = true }
            nodes[190][87045354] = { mnID = 189, dnID = DUNGEON_FLOOR_ICECROWNCITADEL6, name = "", type = "PassageDownL", showInZone = true }
            nodes[191][22693377] = { mnID = 190, dnID = DUNGEON_FLOOR_ICECROWNCITADEL5, name = "", type = "PassageUpL", showInZone = true }
            nodes[191][80143306] = { mnID = 190, dnID = DUNGEON_FLOOR_ICECROWNCITADEL5, name = "", type = "PassageUpL", showInZone = true }
            nodes[191][51267309] = { mnID = 190, dnID = DUNGEON_FLOOR_ICECROWNCITADEL5, name = "", type = "PassageDownL", showInZone = true }
            nodes[189][36499219] = { mnID = 190, dnID = DUNGEON_FLOOR_ICECROWNCITADEL5, name = "", type = "PassageUpL", showInZone = true }
            nodes[189][51833323] = { mnID = 190, dnID = DUNGEON_FLOOR_ICECROWNCITADEL5, name = "", type = "PassageUpL", showInZone = true }
          --Azjol-Nerub
            nodes[159][66171948] = { mnID = 158, dnID = DUNGEON_FLOOR_AZJOLNERUB2, name = "", type = "PassageDownL", showInZone = true }
            nodes[158][39012748] = { mnID = 159, dnID = DUNGEON_FLOOR_AZJOLNERUB3, name = "", type = "PassageUpL", showInZone = true }
            nodes[158][49795861] = { mnID = 157, dnID = DUNGEON_FLOOR_AZJOLNERUB1, name = "", type = "PassageDownL", showInZone = true }
          --The Oculus
            nodes[142][49334887] = { mnID = 143, name = "", type = "PassageUpL", showInZone = true }
            nodes[143][49378227] = { mnID = 145, dnID = DUNGEON_FLOOR_NEXUS802, name = "", type = "PassageUpL", showInZone = true }
            nodes[144][51418305] = { mnID = 143, dnID = DUNGEON_FLOOR_NEXUS801, name = "", type = "PassageDownL", showInZone = true }
            nodes[144][47648305] = { mnID = 145, dnID = DUNGEON_FLOOR_NEXUS803, name = "", type = "PassageUpL", showInZone = true }
            nodes[145][46237198] = { mnID = 146, dnID = DUNGEON_FLOOR_NEXUS803, name = "", type = "PassageUpL", showInZone = true }
            nodes[145][52677198] = { mnID = 144, dnID = DUNGEON_FLOOR_NEXUS804, name = "", type = "PassageDownL", showInZone = true }
            nodes[146][47647339] = { mnID = 145, dnID = DUNGEON_FLOOR_NEXUS804, name = "", type = "PassageDownL", showInZone = true }

        --##########################
        --#### Pandaria Passage ####
        --##########################
          --Temple of the Jade Serpent
            nodes[429][26586218] = { mnID = 430, dnID = DUNGEON_FLOOR_EASTTEMPLE2, name = "", type = "PassageLeftL", showInZone = true }
            nodes[429][25856779] = { mnID = 430, dnID = DUNGEON_FLOOR_EASTTEMPLE2, name = "", type = "PassageRightL", showInZone = true }
            nodes[430][44512435] = { mnID = 429, dnID = DUNGEON_FLOOR_EASTTEMPLE1, name = "", type = "PassageRightL", showInZone = true }
            nodes[430][40903871] = { mnID = 429, dnID = DUNGEON_FLOOR_EASTTEMPLE1, name = "", type = "PassageLeftL", showInZone = true }
          --Mogu'shan Palace
            nodes[453][49786821] = { mnID = 454, dnID = DUNGEON_FLOOR_MOGUSHANPALACE2, name = "", type = "PassageDownL", showInZone = true }
            nodes[454][59572701] = { mnID = 453, dnID = DUNGEON_FLOOR_MOGUSHANPALACE1, name = "", type = "PassageDownL", showInZone = true }
            nodes[454][71587640] = { mnID = 455, dnID = DUNGEON_FLOOR_MOGUSHANPALACE3, name = "", type = "PassageUpL", showInZone = true }
            nodes[455][58982436] = { mnID = 454, dnID = DUNGEON_FLOOR_MOGUSHANPALACE2, name = "", type = "PassageDownL", showInZone = true }
          --Gate of the Setting Sun
            nodes[437][46153314] = { mnID = 438, dnID = DUNGEON_FLOOR_THEGREATWALL2, name = "", type = "PassageUpL", showInZone = true }
            nodes[438][49015147] = { mnID = 437, dnID = DUNGEON_FLOOR_THEGREATWALL1, name = "", type = "PassageDownL", showInZone = true }
          --Siege of Orgrimmar  
            nodes[557][11546798] = { mnID = 556, name = "", type = "PassageDownL", showInZone = true }
            nodes[556][42307149] = { mnID = 558, dnID = DUNGEON_FLOOR_ORGRIMMARRAID1, name = "", type = "PassageLeftL", showInZone = true }
            nodes[558][49786821] = { mnID = 556, name = "", type = "PassageRightL", showInZone = true }
            nodes[559][30233311] = { mnID = 560, dnID = DUNGEON_FLOOR_ORGRIMMARRAID4, name = "", type = "PassageUpL", showInZone = true }
            nodes[560][51577834] = { mnID = 559, dnID = DUNGEON_FLOOR_ORGRIMMARRAID3, name = "", type = "PassageDownL", showInZone = true }
            nodes[560][55962819] = { mnID = 561, dnID = DUNGEON_FLOOR_ORGRIMMARRAID5, name = "", type = "PassageLeftL", showInZone = true }
            nodes[561][77471383] = { mnID = 560, dnID = DUNGEON_FLOOR_ORGRIMMARRAID4, name = "", type = "PassageRightL", showInZone = true }
            nodes[561][69464914] = { mnID = 562, dnID = DUNGEON_FLOOR_ORGRIMMARRAID6, name = "", type = "PassageRightL", showInZone = true }
            nodes[562][30852035] = { mnID = 561, dnID = DUNGEON_FLOOR_ORGRIMMARRAID5, name = "", type = "PassageLeftL", showInZone = true }
            nodes[562][75906108] = { mnID = 563, dnID = DUNGEON_FLOOR_ORGRIMMARRAID7, name = "", type = "PassageDownL", showInZone = true }
            nodes[563][12498658] = { mnID = 562, dnID = DUNGEON_FLOOR_ORGRIMMARRAID6, name = "", type = "PassageUpL", showInZone = true }
            nodes[563][78727363] = { mnID = 564, dnID = DUNGEON_FLOOR_ORGRIMMARRAID8, name = "", type = "PassageLeftL", showInZone = true }
            nodes[563][90656186] = { mnID = 565, dnID = DUNGEON_FLOOR_ORGRIMMARRAID9, name = "", type = "PassageRightL", showInZone = true }
            nodes[563][87987528] = { mnID = 566, dnID = DUNGEON_FLOOR_ORGRIMMARRAID10, name = "", type = "PassageDownL", showInZone = true }
            nodes[564][64751634] = { mnID = 563, dnID = DUNGEON_FLOOR_ORGRIMMARRAID7, name = "", type = "PassageRightL", showInZone = true }
            nodes[565][24738038] = { mnID = 563, dnID = DUNGEON_FLOOR_ORGRIMMARRAID7, name = "", type = "PassageLeftL", showInZone = true }
            nodes[566][32421493] = { mnID = 563, dnID = DUNGEON_FLOOR_ORGRIMMARRAID7, name = "", type = "PassageUpL", showInZone = true }
            nodes[566][65229192] = { mnID = 567, dnID = DUNGEON_FLOOR_ORGRIMMARRAID11, name = "", type = "PassageDownL", showInZone = true }
            nodes[567][53611241] = { mnID = 566, dnID = DUNGEON_FLOOR_ORGRIMMARRAID10, name = "", type = "PassageUpL", showInZone = true }
          --Stormstout Brewery
            nodes[439][28026061] = { mnID = 440, dnID = DUNGEON_FLOOR_STORMSTOUTBREWERY2, name = "", type = "PassageRightL", showInZone = true }
            nodes[440][31015997] = { mnID = 439, dnID = DUNGEON_FLOOR_STORMSTOUTBREWERY1, name = "", type = "PassageLeftL", showInZone = true }
            nodes[440][81395880] = { mnID = 441, dnID = DUNGEON_FLOOR_STORMSTOUTBREWERY3, name = "", type = "PassageLeftL", showInZone = true }
            nodes[441][29754907] = { mnID = 440, dnID = DUNGEON_FLOOR_STORMSTOUTBREWERY2, name = "", type = "PassageLeftL", showInZone = true }
            nodes[441][74803353] = { mnID = 442, dnID = DUNGEON_FLOOR_STORMSTOUTBREWERY4, name = "", type = "PassageLeftL", showInZone = true }
            nodes[442][60672934] = { mnID = 441, dnID = DUNGEON_FLOOR_STORMSTOUTBREWERY3, name = "", type = "PassageRightL", showInZone = true }
          --Mogu'shan Vaults
            nodes[471][31951288] = { mnID = 472, dnID = DUNGEON_FLOOR_MOGUSHANVAULTS2, name = "", type = "PassageUpL", showInZone = true }
            nodes[472][77628345] = { mnID = 471, dnID = DUNGEON_FLOOR_MOGUSHANVAULTS1, name = "", type = "PassageUpL", showInZone = true }
            nodes[472][29945168] = { mnID = 473, dnID = DUNGEON_FLOOR_MOGUSHANVAULTS3, name = "", type = "PassageLeftL", showInZone = true }
            nodes[473][64601022] = { mnID = 472, dnID = DUNGEON_FLOOR_MOGUSHANVAULTS2, name = "", type = "PassageRightL", showInZone = true }
          --Shado-Pan Monastery
            nodes[444][25418244] = { mnID = 443, dnID = DUNGEON_FLOOR_SHADOWPANHIDEOUT0, name = "", type = "PassageLeftL", showInZone = true }
            nodes[443][56288651] = { mnID = 444, dnID = DUNGEON_FLOOR_SHADOWPANHIDEOUT1, name = "", type = "PassageRightL", showInZone = true }
            nodes[443][36037991] = { mnID = 445, dnID = DUNGEON_FLOOR_SHADOWPANHIDEOUT2, name = "", type = "PassageLeftL", showInZone = true }
            nodes[443][24576696] = { mnID = 445, dnID = DUNGEON_FLOOR_SHADOWPANHIDEOUT2, name = "", type = "PassageRightL", showInZone = true }
            nodes[443][31633424] = { mnID = 446, dnID = DUNGEON_FLOOR_SHADOWPANHIDEOUT3, name = "", type = "PassageRightL", showInZone = true }
            nodes[443][44353801] = { mnID = 446, dnID = DUNGEON_FLOOR_SHADOWPANHIDEOUT3, name = "", type = "PassageUpL", showInZone = true }
            nodes[445][71357575] = { mnID = 443, dnID = DUNGEON_FLOOR_SHADOWPANHIDEOUT0, name = "", type = "PassageRightL", showInZone = true }
            nodes[445][18291877] = { mnID = 443, dnID = DUNGEON_FLOOR_SHADOWPANHIDEOUT0, name = "", type = "PassageLeftL", showInZone = true }
            nodes[446][19557104] = { mnID = 443, dnID = DUNGEON_FLOOR_SHADOWPANHIDEOUT0, name = "", type = "PassageLeftL", showInZone = true }
            nodes[446][51418046] = { mnID = 443, dnID = DUNGEON_FLOOR_SHADOWPANHIDEOUT0, name = "", type = "PassageDownL", showInZone = true }
          --Heart of Fear  
            nodes[474][31951540] = { mnID = 475, dnID = DUNGEON_FLOOR_HEARTOFFEAR2, name = "", type = "PassageUpL", showInZone = true }
            nodes[475][66432526] = { mnID = 474, dnID = DUNGEON_FLOOR_HEARTOFFEAR1, name = "", type = "PassageDownL", showInZone = true }
          --Siege of Niuzao Temple
            nodes[458][53618109] = { mnID = 459, dnID = DUNGEON_FLOOR_SIEGEOFNIUZAOTEMPLE2, name = "", type = "PassageRightL", showInZone = true }
            nodes[459][55967881] = { mnID = 458, dnID = DUNGEON_FLOOR_SIEGEOFNIUZAOTEMPLE1, name = "", type = "PassageLeftL", showInZone = true }
            nodes[459][22065244] = { mnID = 457, name = "", type = "PassageRightL", showInZone = true }
            nodes[457][48827254] = { mnID = 459, dnID = DUNGEON_FLOOR_SIEGEOFNIUZAOTEMPLE2, name = "", type = "PassageRightL", showInZone = true }
          --Throne of Thunder
            nodes[508][84067924] = { mnID = 509, dnID = DUNGEON_FLOOR_THUNDERKINGRAID2, name = "", type = "PassageRightL", showInZone = true }
            nodes[509][17127885] = { mnID = 508, dnID = DUNGEON_FLOOR_THUNDERKINGRAID1, name = "", type = "PassageLeftL", showInZone = true }
            nodes[509][64541905] = { mnID = 510, dnID = DUNGEON_FLOOR_THUNDERKINGRAID3, name = "", type = "PassageDownL", showInZone = true }
            nodes[510][74605616] = { mnID = 511, dnID = DUNGEON_FLOOR_THUNDERKINGRAID4, name = "", type = "PassageDownL", showInZone = true }
            nodes[511][21281924] = { mnID = 510, dnID = DUNGEON_FLOOR_THUNDERKINGRAID3, name = "", type = "PassageUpL", showInZone = true }
            nodes[511][33725525] = { mnID = 512, dnID = DUNGEON_FLOOR_THUNDERKINGRAID5, name = "", type = "PassageLeftL", showInZone = true }
            nodes[512][77150834] = { mnID = 511, dnID = DUNGEON_FLOOR_THUNDERKINGRAID4, name = "", type = "PassageRightL", showInZone = true }
            nodes[512][46702011] = { mnID = 513, dnID = DUNGEON_FLOOR_THUNDERKINGRAID6, name = "", type = "PassageUpL", showInZone = true }
            nodes[513][88457598] = { mnID = 512, dnID = DUNGEON_FLOOR_THUNDERKINGRAID7, name = "", type = "PassageRightL", showInZone = true }
            nodes[513][20497033] = { mnID = 514, dnID = DUNGEON_FLOOR_THUNDERKINGRAID5, name = "", type = "PassageDownL", showInZone = true }
            nodes[514][46391022] = { mnID = 513, dnID = DUNGEON_FLOOR_THUNDERKINGRAID6, name = "", type = "PassageLeftL", showInZone = true }

        --##########################
        --#### Draenor Passage #####
        --##########################
          --Skyreach
            nodes[601][42546882] = { mnID = 602, dnID = DUNGEON_FLOOR_SPIRESOFARAKDUNGEON2, name = "", type = "PassageRightL", showInZone = true }
            nodes[602][18247372] = { mnID = 601, dnID = DUNGEON_FLOOR_SPIRESOFARAKDUNGEON1, name = "", type = "PassageLeftL", showInZone = true }
          --Shadowmoon Burial Grounds  
            nodes[574][89825168] = { mnID = 575, dnID = DUNGEON_FLOOR_SHADOWMOONDUNGEON2, name = "", type = "PassageRightL", showInZone = true }
            nodes[575][06006355] = { mnID = 574, dnID = DUNGEON_FLOOR_SHADOWMOONDUNGEON1, name = "", type = "PassageDownL", showInZone = true }
            nodes[575][75407336] = { mnID = 576, dnID = DUNGEON_FLOOR_SHADOWMOONDUNGEON3, name = "", type = "PassageDownL", showInZone = true }
          --The Everbloon  
            nodes[620][43633505] = { mnID = 621, dnID = DUNGEON_FLOOR_OVERGROWNOUTPOST1, name = "", type = "PassageLeftL", showInZone = true }
            nodes[621][45049165] = { mnID = 620, dnID = DUNGEON_FLOOR_OVERGROWNOUTPOST0, name = "", type = "PassageDownL", showInZone = true }
          --Highmaul  
            nodes[611][47024695] = { mnID = 612, dnID = DUNGEON_FLOOR_HIGHMAULRAID2, name = "", type = "PassageUpL", showInZone = true }
            nodes[612][25542291] = { mnID = 610, name = "", type = "PassageLeftL", showInZone = true }
            nodes[610][59267869] = { mnID = 612, dnID = DUNGEON_FLOOR_HIGHMAULRAID2, name = "", type = "PassageRightL", showInZone = true }
            nodes[610][12173714] = { mnID = 613, dnID = DUNGEON_FLOOR_HIGHMAULRAID3, name = "", type = "PassageLeftL", showInZone = true }
            nodes[613][83906246] = { mnID = 610, name = "", type = "PassageDownL", showInZone = true }
            nodes[613][29445472] = { mnID = 614, dnID = DUNGEON_FLOOR_HIGHMAULRAID4, name = "", type = "PassageUpL", showInZone = true }
            nodes[614][35856450] = { mnID = 613, dnID = DUNGEON_FLOOR_HIGHMAULRAID3, name = "", type = "PassageRightL", showInZone = true }
          --Hellfire Citadel
            nodes[661][34155095] = { mnID = 662, dnID = DUNGEON_FLOOR_HELLFIRERAID1, name = "", type = "PassageLeftL", showInZone = true }
            nodes[662][92384749] = { mnID = 661, name = "", type = "PassageRightL", showInZone = true }
            nodes[662][72132183] = { mnID = 663, dnID = DUNGEON_FLOOR_HELLFIRERAID2, name = "", type = "PassageUpL", showInZone = true }
            nodes[662][72137410] = { mnID = 665, dnID = DUNGEON_FLOOR_HELLFIRERAID4, name = "", type = "PassageDownL", showInZone = true }
            nodes[662][72137410] = { mnID = 665, dnID = DUNGEON_FLOOR_HELLFIRERAID4, name = "", type = "PassageDownL", showInZone = true }
            nodes[663][67899058] = { mnID = 662, dnID = DUNGEON_FLOOR_HELLFIRERAID1, name = "", type = "PassageDownL", showInZone = true }
            nodes[663][50781901] = { mnID = 664, dnID = DUNGEON_FLOOR_HELLFIRERAID3, name = "", type = "PassageUpL", showInZone = true }
            nodes[664][60998745] = { mnID = 663, dnID = DUNGEON_FLOOR_HELLFIRERAID2, name = "", type = "PassageDownL", showInZone = true }
            nodes[665][81710935] = { mnID = 662, dnID = DUNGEON_FLOOR_HELLFIRERAID3, name = "", type = "PassageUpL", showInZone = true }
            nodes[666][45459451] = { mnID = 668, dnID = DUNGEON_FLOOR_HELLFIRERAID7, name = "", type = "PassageDownL", showInZone = true }
            nodes[666][61938580] = { mnID = 668, dnID = DUNGEON_FLOOR_HELLFIRERAID7, name = "", type = "PassageDownL", showInZone = true }
            nodes[666][87985119] = { mnID = 667, dnID = DUNGEON_FLOOR_HELLFIRERAID6, name = "", type = "PassageRightL", showInZone = true }
            nodes[668][42420768] = { mnID = 666, dnID = DUNGEON_FLOOR_HELLFIRERAID5, name = "", type = "PassageUpL", showInZone = true }
            nodes[668][29071967] = { mnID = 666, dnID = DUNGEON_FLOOR_HELLFIRERAID5, name = "", type = "PassageUpL", showInZone = true } 
            nodes[667][18455103] = { mnID = 666, dnID = DUNGEON_FLOOR_HELLFIRERAID5, name = "", type = "PassageLeftL", showInZone = true }
            nodes[662][72137410] = { mnID = 665, dnID = DUNGEON_FLOOR_HELLFIRERAID4, name = "", type = "PassageDownL", showInZone = true }
            nodes[662][72137410] = { mnID = 665, dnID = DUNGEON_FLOOR_HELLFIRERAID4, name = "", type = "PassageDownL", showInZone = true }
            nodes[662][72137410] = { mnID = 665, dnID = DUNGEON_FLOOR_HELLFIRERAID4, name = "", type = "PassageDownL", showInZone = true }
            nodes[662][72137410] = { mnID = 665, dnID = DUNGEON_FLOOR_HELLFIRERAID4, name = "", type = "PassageDownL", showInZone = true }
            nodes[662][72137410] = { mnID = 665, dnID = DUNGEON_FLOOR_HELLFIRERAID4, name = "", type = "PassageDownL", showInZone = true }
          --Grimrail Depot
            nodes[606][74102608] = { mnID = 607, dnID = DUNGEON_FLOOR_BLACKROCKTRAINDEPOTDUNGEON2, name = "", type = "PassageLeftL", showInZone = true }
            nodes[607][67842591] = { mnID = 606, dnID = DUNGEON_FLOOR_BLACKROCKTRAINDEPOTDUNGEON1, name = "", type = "PassageRightL", showInZone = true }
            nodes[607][70087509] = { mnID = 608, dnID = DUNGEON_FLOOR_BLACKROCKTRAINDEPOTDUNGEON3, name = "", type = "PassageUpL", showInZone = true } 
            nodes[608][08205180] = { mnID = 609, dnID = DUNGEON_FLOOR_BLACKROCKTRAINDEPOTDUNGEON4, name = "", type = "PassageLeftL", showInZone = true }
            nodes[609][90615132] = { mnID = 608, dnID = DUNGEON_FLOOR_BLACKROCKTRAINDEPOTDUNGEON3, name = "", type = "PassageRightL", showInZone = true }
          -- Blackrock Foundry
            nodes[598][50846857] = { mnID = 597, dnID = DUNGEON_FLOOR_FOUNDRYRAID2, name = "", type = "PassageLeftL", showInZone = true }
            nodes[598][28405382] = { mnID = 596, dnID = DUNGEON_FLOOR_FOUNDRYRAID1, name = "", type = "PassageDownL", showInZone = true }
            nodes[598][53454248] = { mnID = 599, dnID = DUNGEON_FLOOR_FOUNDRYRAID4, name = "", type = "PassageRightL", showInZone = true }
            nodes[598][34771540] = { mnID = 600, dnID = DUNGEON_FLOOR_FOUNDRYRAID5, name = "", type = "PassageLeftL", showInZone = true }
            nodes[600][52989216] = { mnID = 598, dnID = DUNGEON_FLOOR_FOUNDRYRAID3, name = "", type = "PassageRightL", showInZone = true }
            nodes[596][46705708] = { mnID = 598, dnID = DUNGEON_FLOOR_FOUNDRYRAID3, name = "", type = "PassageUpL", showInZone = true }
            nodes[597][65185336] = { mnID = 598, dnID = DUNGEON_FLOOR_FOUNDRYRAID3, name = "", type = "PassageLeftL", showInZone = true }
            nodes[599][41058439] = { mnID = 598, dnID = DUNGEON_FLOOR_FOUNDRYRAID3, name = "", type = "PassageLeftL", showInZone = true }
            nodes[599][55024931] = { mnID = 596, dnID = DUNGEON_FLOOR_FOUNDRYRAID1, name = "", type = "PassageLeftL", showInZone = true }
          end
        ...
        --###################################  
          ...
          --Icecrown Citadel
            ...
            nodes[189][25693280] = { mnID = 190, dnID = DUNGEON_FLOOR_ICECROWNCITADEL5, name = "", type = "Portal", showInZone = true }
            nodes[192][56087032] = { mnID = 186, dnID = DUNGEON_FLOOR_ICECROWNCITADEL1, name = "", type = "Portal", showInZone = true }
            nodes[190][51717343] = { dnID = "•" .. DUNGEON_FLOOR_ICECROWNCITADEL1 .. "\n" .. "•" .. DUNGEON_FLOOR_ICECROWNCITADEL2 .. "\n" .. "•" ..DUNGEON_FLOOR_ICECROWNCITADEL3 .. "\n" .. "•" ..DUNGEON_FLOOR_ICECROWNCITADEL4, name = "", type = "Portal", showInZone = true }
