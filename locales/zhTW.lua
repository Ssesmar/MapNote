...
L["Shows icons of special mixed transport options for Horde and Alliance (Portal+Ship etc) and special individual transport options on this map"] = "在這張地圖上顯示部落和聯盟的特殊混合運輸選項（傳送門+船舶等）以及特殊的個人運輸選項的圖標"
