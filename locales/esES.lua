...
L["Special Icons"] = "símbolos especiales"
...
L["Shows icons of special mixed transport options for Horde and Alliance (Portal+Ship etc) and special individual transport options on this map"] = "Muestra iconos de opciones especiales de transporte mixto para la Horda y la Alianza (Portal+Barco, etc.) y opciones especiales de transporte individual en este mapa."
