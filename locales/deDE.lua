...
L["Special Icons"] = "spezielle Symbole"
...
L["Shows icons of special mixed transport options for Horde and Alliance (Portal+Ship etc) and special individual transport options on this map"] = "Zeigt auf dieser Karte Symbole für besondere gemischte Transportmöglichkeiten für Horde und Allianz (Portal + Schiff usw.) und besondere individuelle Transportmöglichkeiten an"
