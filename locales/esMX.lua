...
L["Special Icons"] = "Iconos especiales"
...
L["Shows icons of special mixed transport options for Horde and Alliance (Portal+Ship etc) and special individual transport options on this map"] = "Muestra iconos de opciones de transporte mixto especiales para la Horda y la Alianza (Portal+Nave, etc.) y opciones de transporte individuales especiales en este mapa"
