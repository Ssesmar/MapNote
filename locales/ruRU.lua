...
L["Special Icons"] = "специальные значки"
...
L["Shows icons of special mixed transport options for Horde and Alliance (Portal+Ship etc) and special individual transport options on this map"] = "Показывает на этой карте значки специальных смешанных вариантов транспорта для Орды и Альянса (Портал+Корабль и т. д.), а также специальные индивидуальные варианты транспорта."
