...
L["Special Icons"] = "icônes spéciales"
...
L["Shows icons of special mixed transport options for Horde and Alliance (Portal+Ship etc) and special individual transport options on this map"] = "Affiche des icônes d'options de transport mixtes spéciales pour la Horde et l'Alliance (Portail + Navire, etc.) et des options de transport individuelles spéciales sur cette carte"
