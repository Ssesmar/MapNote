...
L["Shows icons of special mixed transport options for Horde and Alliance (Portal+Ship etc) and special individual transport options on this map"] = "이 지도에는 호드와 얼라이언스(포탈+선박 등)의 특별 혼합 운송 옵션과 특별 개별 운송 옵션의 아이콘이 표시됩니다"
