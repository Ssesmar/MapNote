...
L["Special Icons"] = "ícones especiais"
...
L["Shows icons of special mixed transport options for Horde and Alliance (Portal+Ship etc) and special individual transport options on this map"] = "Mostra ícones de opções especiais de transporte misto para Horda e Aliança (Portal+Navio etc.) e opções especiais de transporte individual neste mapa"
