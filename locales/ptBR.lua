...
L["Changes the size of the symbols"] = "Muda o tamanho do símbolos"
...
L["Appears first after a certain instance progress \n or requires a certain achievement"] = "Aparece primeiro após um certo progresso da instância \n ou requer uma certa conquista"