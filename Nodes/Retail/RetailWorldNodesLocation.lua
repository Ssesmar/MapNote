    ...
    if not db.show.HideMapNote then
        ...
        -- Kul'Tiras
            if self.db.profile.showCosmosKulTiras then
                nodes[946][61006930] = { mnID = 876, name = SPLASH_BATTLEFORAZEROTH_BOX_RIGHT_TITLE_ALLIANCE, type = "LKT", showInZone = true } -- Expansion Logo
                nodes[946][61007400] = { mnID = 876, id = { 1179, 1176, 1177 }, type = "Raid", showInZone = true } -- Raids
                nodes[946][61007850] = { mnID = 876, id = { 1001, 1021, 1036, 1002 ,1178}, type = "Dungeon", showInZone = true } -- Dungeons
                nodes[946][61008300] = { mnID = 876, name = "", type = "Portal", showInZone = true, TransportName = L["Boralus"] .. "\n" .. L["Portalroom"] .. "\n" .. " => " .. STORMWIND .. "\n" .. " => " .. L["Silithus"] .. "\n" .. " => " .. L["Exodar"] .. "\n" .. " => " .. L["Ironforge"] .. "\n" .. "\n" .. L["Portals"] .. "\n" .. " => " .. L["Arathi Highlands"] .. "\n" .. " => " .. L["Darkshore"] } -- Portals 
                nodes[946][61008750] = { mnID = 1161, id = { 1176, 1031, 1179, 1036 }, type = "LFR", showInZone = true, name = L["Kiku"] .. "\n" .. L["Registrant"] .. " - " .. RAID_FINDER .. "\n" .. " " } -- LFR
        ...
        -- Dragonflight    
            if self.db.profile.showCosmosDragonIsles then
                nodes[946][64606930] = { mnID = 1978, name = EXPANSION_NAME9, type = "LDF", showInZone = true } -- Expansion Logo
                nodes[946][64607400] = { mnID = 1978, id = { 1200, 1208, 1207 }, type = "Raid", showInZone = true } -- Raids
                nodes[946][64607850] = { mnID = 1978, id = { 1202, 1199, 1198, 1196, 1203, 1201, 1204, 1209 }, type = "Dungeon", showInZone = true } -- Dungeons
                nodes[946][64608300] = { mnID = 1978, name = "", type = "Portal", showInZone = true, TransportName = L["Valdrakken"] .. " " .. L["Portals"] .. "\n" .. " => " .. L["Emerald Dream"] .. "\n" .. " => " .. L["Badlands"] .. "\n".." => " .. STORMWIND .. "\n" .. " => " .. ORGRIMMAR .. "\n" .. "\n" .. L["Bel'ameth, Amirdrassil"] .. "\n" .. L["Portals"] .. "\n" .. " => " .. STORMWIND .. "\n" .. " => " .. L["Darkshore"] .. "\n" .. " => " .. POSTMASTER_LETTER_HYJAL  .. "\n" .. " => " .. POSTMASTER_LETTER_LORLATHIL} -- Portals 
