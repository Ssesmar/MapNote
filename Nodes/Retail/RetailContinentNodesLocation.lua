      ...
      if db.activate.Continent then
        ...
        --Draenor Portals
         ...
         --Draenor LFR
          if self.db.profile.showContinentLFR then
            ...
            if self.faction == "Alliance" or db.activate.EnemyFaction then
              nodes[539][29021652] = { mnID = 582, id = { 477, 457, 669 }, type = "LFR", showOnContinent = true, showInZone = false, showOnMinimap = false, name = L["Seer Kazal"] .. " - " .. REQUIRES_LABEL .. " " .. GARRISON_LOCATION_TOOLTIP .. " " .. LEVEL .. " " .. ACTION_SPELL_CAST_START_MASTER .. "\n" .. L["Registrant"] .. " - " .. RAID_FINDER .. "\n" .. " " }
            end
          end
        end
        ...
        -- Zandalar Transport
          if self.db.profile.showContinentTransport then
            ...
            if self.faction == "Alliance" or db.activate.EnemyFaction then
              nodes[875][33051846] = { mnID = 864, name = "", type = "KulM", showOnContinent = true, showInZone = false, showOnMinimap = false, TransportName = L["Barnard 'The Smasher' Bayswort"] .. " " .. L["Travel"] .. "\n" .. "\n" .. " => " .. L["Boralus, Tiragarde Sound"] } -- Transport from Vol'dun to Boralus
              nodes[875][62402600] = { mnID = 863, name = "", type = "DwarfF", showOnContinent = true, showInZone = false, showOnMinimap = false, TransportName = L["Desha Stormwallow"] .. " " .. L["Travel"] .. "\n" .. "\n" .. " => " .. L["Boralus, Tiragarde Sound"] } -- Transport from Nazmir to Boralus
              nodes[875][47177779] = { mnID = 862, name = "", type = "GilneanF", showOnContinent = true, showInZone = false, showOnMinimap = false, TransportName = L["Daria Smithson"] .. " " .. L["Travel"] .. "\n" .. "\n" .. " => " .. L["Boralus, Tiragarde Sound"] } -- Transport from Zuldazar to Boralus 
            end
          end
        ...
        -- Kul Tiras Ships
          ...
          if self.db.profile.showContinentTransport then
            ...
            if self.faction == "Horde" or db.activate.EnemyFaction then
              nodes[876][25676657] = { mnID = 896, name = "", type = "MOrcF", showOnContinent = true, showInZone = false, showOnMinimap = false, TransportName = L["Swellthrasher"] .. " " .. L["Travel"] .. "\n" .. "\n" .. " => " .. L["Zuldazar"] } -- Transport from Drustvar to Zuldazar
              nodes[876][54391406] = { mnID = 942, name = "", type = "OrcM", showOnContinent = true, showInZone = false, showOnMinimap = false, TransportName = L["Grok Seahandler"] .. " " .. L["Travel"] .. "\n" .. "\n" .. " => " .. L["Zuldazar"] } -- Transport from Stormsong Valley to Zuldazar
              nodes[876][68326548] = { mnID = 895, name = "", type = "B11M", showOnContinent = true, showInZone = false, showOnMinimap = false, TransportName = L["Erul Dawnbrook"] .. " " .. L["Travel"] .. "\n" .. "\n" .. " => " .. L["Zuldazar"] } -- Transport from Tiragarde Sound to Zuldazar 
            end
          end
