      ...
      if db.activate.MiniMap then
        ...
        --Eastern Kingdom Portals
          if self.db.profile.showMiniMapPortals then
            ...
            if self.faction == "Horde" or db.activate.EnemyFaction then
              ...
              minimap[17][72694917] = { mnID = 85, name = "" , type = "HPortal", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Portal"] .. " => " .. ORGRIMMAR } -- Portal Blasted Lands to Orgrimmar 
              ...
              minimap[2070][59506694] = { mnID = 85, name = "", type = "HPortal", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Portal"] .. " => " .. ORGRIMMAR } -- Portal to Orgrimmar from Tirisfal
              minimap[2070][59506797] = { mnID = 50, name = "", type = "HPortal", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Portal"] .. " => " .. L["Grom'gol, Stranglethorn Vale"] } -- Portal to Stranglethorn from Tirisfal
              minimap[2070][60126689] = { mnID = 117, name = "", type = "HPortal", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Portal"] .. " => " .. L["Howling Fjord"] } -- Portal to Howling Fjord from Tirisfal
              minimap[2070][59406743] = { mnID = 110, name = "", type = "HPortal", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Portal"] .. " => " .. L["Silvermoon City"] } -- Portal to Silvermoon from Tirisfal
            ...
            if self.faction == "Alliance" or db.activate.EnemyFaction then
              ...
              minimap[17][66382798] = { mnID = 84, name = "" , type = "APortal", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Portal"] .. " => " .. STORMWIND } -- Portal to Stormwind 
        ...
        --Eastern Kingdom Ships
          if self.db.profile.showMiniMapShips then
            ...
            minimap[224][36947582] = { mnID = 10, name = "", type = "Ship", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Ship"] .. " => " .. L["Ratchet"] } -- Ship from Booty Bay to Ratchet
        ...
        -- Zandalar Transport
          if self.db.profile.showMiniMapTransport then
            ...
            if self.faction == "Horde" or db.activate.EnemyFaction then
              minimap[862][58466298] = { mnID = 876, name = L["(Dread-Admiral Tattersail) will take you to Drustvar, Tiragarde Sound or Stormsong Valley"], type = "UndeadF", showInZone = false, showOnContinent = false, showOnMinimap = true } -- Ship from Dazar'alor to Drustvar, Tiragarde Sound or Stormsong Valley
              minimap[862][55325808] = { mnID = 1462, name = L["Captain Krooz"] .. " " .. L["Travel"], type = "GoblinF", showInZone = false, showOnContinent = false, showOnMinimap = true } -- Transport from Dazar'alor to Mechagon 
              minimap[1462][75522266] = { mnID = 862, name = L["Captain Krooz"] .. " " .. L["Travel"], type = "GoblinF", showInZone = false, showOnContinent = false, showOnMinimap = true } -- Transport from Mechagon to Zuldazar
            end

            if self.faction == "Alliance" or db.activate.EnemyFaction then
              minimap[864][36693428] = { mnID = 1161, name = "", type = "KulM", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Barnard 'The Smasher' Bayswort"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Boralus, Tiragarde Sound"] } -- Transport from Vol'dun to Boralus
              minimap[863][62064008] = { mnID = 1161, name = "", type = "DwarfF", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Desha Stormwallow"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Boralus, Tiragarde Sound"] } -- Transport from Nazmir to Boralus
              minimap[862][40457103] = { mnID = 1161, name = "", type = "GilneanF", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Daria Smithson"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Boralus, Tiragarde Sound"] } -- Transport from Zuldazar to Boralus 
            end
          end
        end
        ...
        -- Kul Tiras Transport
          if self.db.profile.showMiniMapTransport then
            ...
            if self.faction == "Horde" or db.activate.EnemyFaction then
              minimap[896][20614336] = { mnID = 862, name = "", type = "MOrcF", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Swellthrasher"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Zuldazar"] } -- Transport from Drustvar to Zuldazar
              minimap[942][51902432] = { mnID = 862, name = "", type = "OrcM", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Grok Seahandler"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Zuldazar"] } -- Transport from Stormsong Valley to Zuldazar
              minimap[895][87725089] = { mnID = 862, name = "", type = "B11M", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Erul Dawnbrook"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Zuldazar"] } -- Transport from Tiragarde Sound to Zuldazar 
            end
        ...
        if self.db.profile.showMiniMapDragonIsles then
          ...
          if self.db.profile.showMiniMapPortals then
            minimap[2239][89643770] = { mnID = "",  name = "", type = "WayGateGreen", showInZone = false, showOnContinent = false, showOnMinimap = true, TransportName = L["Portal"] .. " => " ..L["Emerald Dream"] } -- Bel'ameth, Amirdrassil to Emerald Dream
