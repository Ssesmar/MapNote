      ...
      if db.activate.ZoneMap then
        ...
        --Eastern Kingdom Portals
          if self.db.profile.showZonePortals then
            ...
            if self.faction == "Horde" or db.activate.EnemyFaction then
              ...
              nodes[17][72694917] = { mnID = 85, name = "" , type = "HPortal", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Portal"] .. " => " .. ORGRIMMAR } -- Portal Blasted Lands to Orgrimmar 
              ...
              nodes[2070][59506694] = { mnID = 85, name = "", type = "HPortal", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Portal"] .. " => " .. ORGRIMMAR } -- Portal to Orgrimmar from Tirisfal
              nodes[2070][59506797] = { mnID = 50, name = "", type = "HPortal", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Portal"] .. " => " .. L["Grom'gol, Stranglethorn Vale"] } -- Portal to Stranglethorn from Tirisfal
              nodes[2070][60126689] = { mnID = 117, name = "", type = "HPortal", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Portal"] .. " => " .. L["Howling Fjord"] } -- Portal to Howling Fjord from Tirisfal
              nodes[2070][59406743] = { mnID = 110, name = "", type = "HPortal", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Portal"] .. " => " .. L["Silvermoon City"] } -- Portal to Silvermoon from Tirisfal
            ...
            if self.faction == "Alliance" or db.activate.EnemyFaction then
              ...
              nodes[17][66382798] = { mnID = 84, name = "" , type = "APortal", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Portal"] .. " => " .. STORMWIND } -- Portal to Stormwind 
        ...
        --Eastern Kingdom Ships
          if self.db.profile.showZoneShips then
            ...
            nodes[224][36947582] = { mnID = 10, name = "", type = "Ship", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Ship"] .. " => " .. L["Ratchet"] } -- Ship from Booty Bay to Ratchet
        ...
        -- Northrend Portal
          if self.db.profile.showZonePortals then
            ...
            nodes[127][15724250] = { mnID = 125, TransportName = BATTLE_PET_SOURCE_2 .. " " .. REQUIRES_LABEL .. " " .. "The Magical Kingdom of Dalaran", type = "Portal", showInZone = true, showOnContinent = false, showOnMinimap = false, name = L["Portal"] .. " => " .. DUNGEON_FLOOR_DALARANCITY1, showWWW = true, www = "https://www.wowhead.com/wotlk/quest=12791/the-magical-kingdom-of-dalaran"} -- LakeWintergrasp to Dalaran Portal 
        ...
        --Broken Isles Portals
          if self.db.profile.showZonePortals then
            nodes[630][46674136] = { name = "", type = "Portal", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Portal"] .. "\n" .. " => " .. ORGRIMMAR .. "\n" .. " => " .. STORMWIND} -- Portal to Orgrimmar from Azsuna
        ...
        -- Zandalar Transport
          if self.db.profile.showZoneTransport then
            ...
            if self.faction == "Horde" or db.activate.EnemyFaction then
              nodes[862][58466298] = { mnID = 876, name = L["(Dread-Admiral Tattersail) will take you to Drustvar, Tiragarde Sound or Stormsong Valley"], type = "UndeadF", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Ship from Dazar'alor to Drustvar, Tiragarde Sound or Stormsong Valley
              nodes[862][55325808] = { mnID = 1462, name = L["Captain Krooz"] .. " " .. L["Travel"], type = "GoblinF", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Transport from Dazar'alor to Mechagon 
              nodes[1462][75522266] = { mnID = 862, name = L["Captain Krooz"] .. " " .. L["Travel"], type = "GoblinF", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Transport from Mechagon to Zuldazar
            end

            if self.faction == "Alliance" or db.activate.EnemyFaction then
              nodes[864][36693428] = { mnID = 1161, name = "", type = "KulM", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Barnard 'The Smasher' Bayswort"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Boralus, Tiragarde Sound"] } -- Transport from Vol'dun to Boralus
              nodes[863][62064008] = { mnID = 1161, name = "", type = "DwarfF", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Desha Stormwallow"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Boralus, Tiragarde Sound"] } -- Transport from Nazmir to Boralus
              nodes[862][40457103] = { mnID = 1161, name = "", type = "GilneanF", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Daria Smithson"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Boralus, Tiragarde Sound"] } -- Transport from Zuldazar to Boralus 
            end
          end
        end
        ...
        -- Kul Tiras Transport
          if self.db.profile.showZoneTransport then
            ...
            if self.faction == "Horde" or db.activate.EnemyFaction then
              nodes[896][20614336] = { mnID = 862, name = "", type = "MOrcF", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Swellthrasher"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Zuldazar"] } -- Transport from Drustvar to Zuldazar
              nodes[942][51902432] = { mnID = 862, name = "", type = "OrcM", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Grok Seahandler"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Zuldazar"] } -- Transport from Stormsong Valley to Zuldazar
              nodes[895][87725089] = { mnID = 862, name = "", type = "B11M", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Erul Dawnbrook"] .. " " .. L["Travel"] .. "\n" .. " => " .. L["Zuldazar"] } -- Transport from Tiragarde Sound to Zuldazar 
            end
        ...
        if self.db.profile.showZoneDragonIsles then
          ...
          if self.db.profile.showZonePortals then
            nodes[2239][89643770] = { mnID = "",  name = "", type = "WayGateGreen", showInZone = true, showOnContinent = false, showOnMinimap = false, TransportName = L["Portal"] .. " => " ..L["Emerald Dream"] } -- Bel'ameth, Amirdrassil to Emerald Dream
