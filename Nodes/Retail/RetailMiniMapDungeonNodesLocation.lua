      ...
      if db.activate.MiniMap then
        ...
        -- Eastern Kingdom Dungeons
          ...
          -- Dungeon minimap above Blizzards Icons to make it Clickable for maximized Maps
            ...
            minimap[204][70402953] = { id = 65, type = "Dungeon", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- Throne of the Tides
        ...
        -- Pandaria Raids
          ...
          -- Raid minimap above Blizzards Icons to make it Clickable for maximized Maps
            ...
            minimap[433][48536352] = { id = 320, type = "Raid", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- Terrace of Endless Spring
        ...
        --Broken Isles Raids
          ...
          -- Raid minimap above Blizzards Icons to make it Clickable for maximized Maps
            ...
            minimap[680][44145979] = { id = 786, type = "Raid", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- The Nighthold
        ...
        --Broken Isles Raids without ClassicIcons
          if self.db.profile.showMiniMapPassage and not db.activate.ClassicIcons then
            minimap[680][43346230] = { name = L["Way to the Instance Entrance"], id = { 726, 786 }, type = "PassageDungeonRaidMulti", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- The Arcway
          end
        ...
        --Broken Isles ClassicIcons
          if db.activate.ClassicIcons then
            ...
            if self.db.profile.showMiniMapMultiple then
              minimap[680][43346230] = { name = L["Way to the Instance Entrance"], id = { 726, 786 }, type = "MultipleM", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- The Arcway
            end
          end
        ...
        if self.db.profile.showMiniMapKhazAlgar then
          ...
          -- Khaz Algar Dungeons
            ...
            -- Dungeon minimap above Blizzards Icons to make it Clickable for maximized Maps
            minimap[2215][41324933] = { id = 1267, type = "Dungeon", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- Priory of the Sacred Flame
            minimap[2215][54906313] = { id = 1270, type = "Dungeon", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- The Dawnbreaker
            minimap[2214][46860856] = { id = 1269, type = "Dungeon", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- The Stonevault
            minimap[2248][45234108] = { id = 1268, type = "Dungeon", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- The Rookery
            minimap[2248][76584378] = { id = 1272, type = "Dungeon", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- Cinderbrew Meadery
            minimap[2255][48027144] = { id = 1274, type = "Dungeon", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- City of Threads
            minimap[2255][50588229] = { id = 1271, type = "Dungeon", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- Ara-Kara, City of Echoes
            end
          ...
          -- Khaz Algar Raids
            ...
            -- Raid minimap above Blizzards Icons to make it Clickable for maximized Maps
              minimap[2255][45109080] = { id = 1207, type = "Raid", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- Nerub-ar Palace
              minimap[2213][35047242] = { id = 1200, type = "Raid", showInZone = false, hideOnContinent = true, hideOnMinimap = false } -- Nerub-ar Palace           
            end
