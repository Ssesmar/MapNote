			...
			if self.db.profile.showMiniMapEasternKingdom then
                ...
                if self.db.profile.showMiniMapFP then
                    ...
                    if self.faction == "Horde" or db.activate.EnemyFaction then
                        ...
                        minimap[1422][46446461] = { mnID = 1422, name = MINIMAP_TRACKING_FLIGHTMASTER .. " - " .. FACTION_HORDE, type = "TravelL", showInZone = false, showOnContinent = false, showOnMinimap = true } -- W-Plaquelands
