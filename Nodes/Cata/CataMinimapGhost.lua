		...
		if db.activate.MiniMap then
			...
			if self.db.profile.showMiniMapKalimdor then
                ...
                if self.db.profile.showMiniMapGhost then
                    ...
                    minimap[948][30805000] = { name = SPIRIT_HEALER_RELEASE_RED, type = "Ghost", showInZone = false, showOnContinent = false, showOnMinimap = true } -- The Maelstrom
                end
			...
			if self.db.profile.showMiniMapEasternKingdom then
                ...
                if self.db.profile.showMiniMapGhost then
                    ...
                    minimap[1417][32805040] = { name = SPIRIT_HEALER_RELEASE_RED, type = "Ghost", showInZone = false, showOnContinent = false, showOnMinimap = true } -- Arathi Highlands
