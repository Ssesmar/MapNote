			...
			if self.db.profile.showZoneEasternKingdom then
                ...
                if self.db.profile.showZoneFP then
                    ...
                    if self.faction == "Alliance" or db.activate.EnemyFaction then
                        ...
                        nodes[1419][61282199] = { mnID = 1419, name = MINIMAP_TRACKING_FLIGHTMASTER .. " - " .. FACTION_ALLIANCE, type = "TravelA", showInZone = true, hideOnContinent = true, hideOnMinimap = true } -- Blasted Lands
