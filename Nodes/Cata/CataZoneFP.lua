			...
			if self.db.profile.showZoneEasternKingdom then
                ...
                if self.db.profile.showZoneFP then
                    ...
                    if self.faction == "Horde" or db.activate.EnemyFaction then
                        ...
                        nodes[1422][46446461] = { mnID = 1422, name = MINIMAP_TRACKING_FLIGHTMASTER .. " - " .. FACTION_HORDE, type = "TravelH", showInZone = true, showOnContinent = false, showOnMinimap = false } -- W-Plaquelands
