		...
		if db.activate.ZoneMap then
			...
			if self.db.profile.showZoneKalimdor then
                ...
                if self.db.profile.showZoneGhost then
                    ...
                    nodes[948][30805000] = { name = SPIRIT_HEALER_RELEASE_RED, type = "Ghost", showInZone = true, showOnContinent = false, showOnMinimap = false } -- The Maelstrom
                end
			...
			if self.db.profile.showZoneEasternKingdom then
                ...
                if self.db.profile.showZoneGhost then
                    ...
                    nodes[1417][32805040] = { name = SPIRIT_HEALER_RELEASE_RED, type = "Ghost", showInZone = true, showOnContinent = false, showOnMinimap = false } -- Arathi Highlands
