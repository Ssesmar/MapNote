...
L["Deactivate MapNotes chat messages except 'Hide MapNotes!' and 'MapNotes VS. blizzard'"] = "Деактивировать сообщения чата mapnotes, кроме «скрыть mapnotes!» и 'mapnotes vs. Метель '"
